...
// @HASH:530254542e29785f33c5115a76476dbc770bb74d
// @DATE:Tue Nov 24 18:21:00 PST 2015
...
// @LINE:67
private[this] lazy val controllers_CommentController_addComment45_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("comments/add"))))
...
// @LINE:68
private[this] lazy val controllers_LikeController_addLike46_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("likes/add"))))
private[this] lazy val controllers_LikeController_addLike46_invoker = createInvoker(
...
// @LINE:71
private[this] lazy val controllers_FollowController_addFollow47_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("follow/add"))))
private[this] lazy val controllers_FollowController_addFollow47_invoker = createInvoker(
...
case controllers_CommentController_addComment45_route(params) => {
   call { 
        controllers_CommentController_addComment45_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.CommentController]).addComment)
   }
}
        

// @LINE:68
case controllers_LikeController_addLike46_route(params) => {
   call { 
        controllers_LikeController_addLike46_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.LikeController]).addLike)
   }
}
        

// @LINE:71
case controllers_FollowController_addFollow47_route(params) => {
   call { 
        controllers_FollowController_addFollow47_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.FollowController]).addFollow)
   }
}
...
case controllers_Assets_at48_route(params) => {
   call(Param[String]("path", Right("/public")), params.fromPath[String]("file", None)) { (path, file) =>
        controllers_Assets_at48_invoker.call(controllers.Assets.at(path, file))
   }
}
