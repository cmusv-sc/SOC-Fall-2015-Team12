...
// @LINE:76
private[this] lazy val controllers_Assets_at49_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("assets/"),DynamicPart("file", """.+""",false))))
...
case controllers_Assets_at49_route(params) => {
   call(Param[String]("path", Right("/public")), params.fromPath[String]("file", None)) { (path, file) =>
        controllers_Assets_at49_invoker.call(controllers.Assets.at(path, file))
   }
}
