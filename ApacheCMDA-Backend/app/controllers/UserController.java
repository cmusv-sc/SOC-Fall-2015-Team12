...
public class UserController extends Controller {
		...
		@Inject public UserController(final UserRepository userRepository) {
		...
		public Result addUser() {
				...
				try {
						...
						User user =
								new User(userName, password, firstName, lastName, middleInitial, affiliation, title,
										email, mailingAddress, phoneNumber, faxNumber, researchFields, highestDegree);
		...
		public Result loginTest(String format) {
				String result = new String();
				User u = new User();
